...
OBJS=main.o midi.o device.o dialog.o oscillators.o lfos.o filter.o envelopes.o amplifier.o xmlparser.o
...
main.o: main.h midi.h dialog.h device.h oscillators.h lfos.h filter.h envelopes.h amplifier.h xmlparser.h
midi.o: midi.h
